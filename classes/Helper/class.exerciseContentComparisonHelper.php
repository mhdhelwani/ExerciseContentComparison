...
class exerciseContentComparisonHelper
{
    ...
    {
        include_once("./Customizing/Global/plugins/Services/UIComponent/UserInterfaceHook/ExerciseContentComparison/classes/Helper/DocxConversion.php");
        ...
        if ($extension == 'pdf') {
            spl_autoload_register(function ($class_name) {
                include "./Customizing/Global/plugins/Services/UIComponent/UserInterfaceHook/ExerciseContentComparison/classes/Helper/PdfParser/src/" . $class_name . '.php';
            });
